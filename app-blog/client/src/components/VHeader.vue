<template>
  <div>
    <div class="py-5 text-center">
      ...
      <p class="lead">
        Love is like riding or speaking French,if you don not learn it young,
    ...
    <modal :show="modalName == 'register'" @close="modalClose" title="注册">
      <form>
        <div class="form-group row">
          <label for="reg_username" class="col-md-3 col-form-label"
            >用户名</label
          >
          <div class="col-md-9">
            <input
        ...
        <div class="form-group row">
          <label for="repassword" class="col-md-3 col-form-label"
            >重复密码</label
          >
          <div class="col-md-9">
            <input
      ...
      <template slot="footer">
        <button type="button" class="btn btn-primary" @click="registerSubmit">
          注册
        </button>
    ...
    <modal :show="modalName == 'login'" @close="modalClose" title="登录">
      <form>
        <div class="form-group row">
          <label for="login_username" class="col-md-3 col-form-label"
            >用户名</label
          >
          <div class="col-md-9">
            <input
      ...
      <template slot="footer">
        <button type="button" class="btn btn-primary" @click="loginSubmit">
          登录
        </button>
        <button type="button" class="btn btn-secondary">取消</button>
        <a href="">我有账号，立即登录</a>
